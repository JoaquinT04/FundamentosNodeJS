...
console.table(`tengo ${os.cpus().length} nucleos`);
...
console.log(`tengo ${os.freemem()} bits libres`);
console.log(`tengo ${kb(os.freemem())} kilobyte libres`);
console.log(`tengo ${mb(os.freemem())} megabyte libres`);
console.log(`tengo ${gb(os.freemem())} gigabyte libres`);

console.log(`tengo ${gb(os.totalmem())} gigabyte en total`);

console.log(`mi directorio raiz es: ${os.homedir()}`);
console.log(`mi directorio temporal es: ${os.tmpdir}`);

console.log(os.hostname());
console.table(os.networkInterfaces());
console.log(os.networkInterfaces());p
